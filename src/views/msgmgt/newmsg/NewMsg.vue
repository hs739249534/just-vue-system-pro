...
<!--        <component :is="steps[current].content"></component>-->
        ...
        <new-msg2 v-if="steps[current].content === 'NewMsg2'"></new-msg2>
        <new-msg3 v-if="steps[current].content === 'NewMsg3'"></new-msg3>
      </keep-alive>
    </div>
    <div class="steps-action" style="justify-content: center; display: flex; margin: 24px 0">
